...
class _PdfReportPreviewScreenState extends State<PdfReportPreviewScreen> {
        ...
        build: (ctx) => pw.Container(
          ...
          child: pw.Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      pw.Text(
                        ...
                        style: pw.TextStyle(
                          fontSize: 12,
                          fontWeight: pw.FontWeight.bold,
                          color: PdfColor.fromInt(0xFF7F8FA6),
                        ),
                      ),
                    ],
                  ),
                          ...
                          children: [
                            pw.Container(
                              ...
                              child: pw.Text(
                                ...
                                style: pw.TextStyle(
                                  fontSize: 11,
                                  color: PdfColor.fromInt(0xFF9AA3B2),
                                ),
                              ),
                            ),
                            pw.SizedBox(width: 8),
              ...
              pw.Container(
                decoration: pw.BoxDecoration(
                  color: PdfColor.fromInt(0xFFEBF3FC),
                      ...
                      child: pw.Center(
                        child: pw.Text(
                          ...
                          style: pw.TextStyle(
                            fontSize: 11,
                            fontWeight: pw.FontWeight.bold,
                            color: PdfColor.fromInt(0xFF0D3A7A),
                          ),
                        ),
                      ),
                    ),
                        ...
                        children: [
                          ...
                          pw.Expanded(
                            ...
                            child: pw.Align(
                              ...
                              child: pw.Text(
                                p
                                        .getCourseInfo(grades[i].courseCode)
                                        ?.courseTitle ??
                                    '',
                                style: pw.TextStyle(fontSize: 12),
                              ),
                          ...
                          pw.Container(
                            ...
                            child: pw.Center(
                              child: pw.Text(
                                '${p.getCourseInfo(grades[i].courseCode)?.creditHours ?? 0}',
                                style: pw.TextStyle(
                                  fontSize: 12,
                                  fontWeight: pw.FontWeight.bold,
                                ),
              ...
              pw.Container(
                ...
                child: pw.Row(
                  ...
                  children: [
                    pw.Text(
                      'Total Credit Hours: ${_pdfTotalCredits(p, semester)}',
                      style: pw.TextStyle(
                        fontSize: 12,
                        fontWeight: pw.FontWeight.bold,
                      ),
  ...
  Future<void> _sharePdf() async {
    ...
    try {
      ...
      await Printing.sharePdf(
        bytes: bytes,
        filename: 'Academic_Report_$_selectedSemester.pdf',
      );
    } finally {
      if (mounted) setState(() => _isLoading = false);
    }
  ...
  Widget build(BuildContext context) {
    return Consumer<AppProvider>(
      builder: (context, provider, _) {
        ...
        final semester =
            _selectedSemester ??
            (provider.semesters.isNotEmpty ? provider.semesters.last : '');
        final grades = semester.isEmpty
            ? <dynamic>[]
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'Total Credit Hours: ${_calculateTotalCredits(provider, semester)}',
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                          ),
                                        ),
                                        Row(
                                          children: [
                                            Text(
                                              'GPA: ${provider.selectedGPA.toStringAsFixed(2)}',
                                              style: const TextStyle(
                                                fontWeight: FontWeight.bold,
                                              ),
                                            ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed:
                                  (_isLoading || _selectedSemester == null)
                                  ? null
                                  : _generatePdf,
  ...
  TableRow _buildGradeTableRow(AppProvider provider, dynamic g) {
    final c = provider.getCourseInfo(g.courseCode);
    return TableRow(
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 4),
          child: Text(g.courseCode ?? '', style: const TextStyle(fontSize: 13)),
        ),
        Padding(
          padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 4),
          child: Text(
        ...
        Padding(
          ...
          child: Center(
            child: Text(
              _gradePointFromLetter(g.letterGrade ?? '').toStringAsFixed(2),
              style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600),
            ),
          ),
        ),
